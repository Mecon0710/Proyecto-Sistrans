...
//			e.printStackTrace ();
	 ...
	 *****************************************************************/
    /**
     * Registra un usuario con la información dada
     * Se crea una nueva tupla de usuario en la base de datos, si un usuario con ese número de documento no existía
     */
    public void registrarUsuario( )
    {
    	try 
    	{
    		...
    		int documNum = Integer.valueOf(JOptionPane.showInputDialog (this, "Número de documento", "Registrar un usuario", JOptionPane.QUESTION_MESSAGE));
    		String nacionalidad = JOptionPane.showInputDialog (this, "Nacionalidad", "Registrar un usuario", JOptionPane.QUESTION_MESSAGE);
    		String direccFisica = JOptionPane.showInputDialog (this, "Dirección física", "Registrar un usuario", JOptionPane.QUESTION_MESSAGE);
    		String direccElectro = JOptionPane.showInputDialog (this, "Correo", "Registrar un usuario", JOptionPane.QUESTION_MESSAGE);
    		int telefono = Integer.valueOf(JOptionPane.showInputDialog (this, "Teléfono ", "Registrar un usuario", JOptionPane.QUESTION_MESSAGE));
    		...
    		int codPostal = Integer.valueOf(JOptionPane.showInputDialog (this, "Código postal", "Registrar un usuario", JOptionPane.QUESTION_MESSAGE));
